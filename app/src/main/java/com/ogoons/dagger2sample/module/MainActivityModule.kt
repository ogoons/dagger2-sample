...
import com.ogoons.dagger2sample.component.MainFragmentComponent
...
@Module(subcomponents = arrayOf(MainFragmentComponent::class)) // 상위 모듈(MainActivityModule)에 subcomponent인 MobilityComponent를 적용하면 부모, 자식 관계가 된다.
